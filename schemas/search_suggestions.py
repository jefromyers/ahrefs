...
class SearchSuggestionsSelect(str, Enum):
    cpc = "cpc"
    cps = "cps"
...
class SearchSuggestionsRequest(BaseRequest):
    _endpoint: str = PrivateAttr("/v3/keywords-explorer/search-suggestions")
    ...
    # Required fields
    select: List[SearchSuggestionsSelect] = Field(
        ...,
        title="Select",
        description=(
...
@response_for(SearchSuggestionsRequest)
