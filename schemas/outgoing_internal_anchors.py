...
class OutgoingInternalAnchorsSelect(str, Enum):
    anchor = "anchor"
...
class OutgoingInternalAnchorsRequest(BaseRequest):
    _endpoint: str = PrivateAttr("/v3/site-explorer/linked-anchors-internal")
    ...
    # Required fields
    select: List[OutgoingInternalAnchorsSelect] = Field(
        ...,
        title="Select",
        description=(
...
@response_for(OutgoingInternalAnchorsRequest)
class OutgoingInternalAnchorsResponse(BaseResponse):
